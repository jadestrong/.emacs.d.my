...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(arjen-grey-theme highlight-indent-guides magit json-mode smartparens better-shell exec-path-from-shell dracula-theme linum-relative solarized-theme ag dumb-jump smart-tabs-mode eslint-fix js2-mode web-mode undo-tree djvu vue-mode vue-mod elfeed-org zenburn-theme which-key use-package try org-bullets counsel color-theme auto-complete ace-window)))
